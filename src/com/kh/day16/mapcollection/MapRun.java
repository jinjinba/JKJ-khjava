...
public class MapRun {
	public static void main(String [] args) {
		...
		stdMap.put("1", new Student("현빈", 55, 100));
		
		System.out.println("첫번째 학생 : " + stdMap.get("1").toString());
	}
	public void mapExample1() {
		Map<String, String> map = new HashMap<String, String>();	//Map util import
		map.put("02", "서울");
		map.put("031", "경기도");
		map.put("061", "전라도");
		map.put("053", "대구");
		...
		System.out.println("02누르면 서울이 나옵니다 : " + map.get("031"));
	...
	public void mapExample2() {
		Map<String, Object> objMap = new HashMap<String, Object>();	//Map util import
		objMap.put("name", "핫팩");
